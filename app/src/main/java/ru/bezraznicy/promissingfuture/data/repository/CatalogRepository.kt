...
class CatalogRepository(private val catalogDao: CatalogDao): ModelRepository<Catalog> {
    override fun insert(catalog: Catalog) = catalogDao.insert(catalog)

    override fun delete(catalog: Catalog) = catalogDao.delete(catalog)
    ...
    override fun selectById(id: Long): Catalog = catalogDao.selectById(id)

    override fun selectAll(): List<Catalog> = catalogDao.selectAll()
}